...
-- -----------------------------------------------------
-- Table `SpotifyClone`.`subscriptions`
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `SpotifyClone`.`album` (
  ...
  INDEX `id_artist_idx` (`artist_id` ASC) VISIBLE,
...
INSERT INTO subscriptions (plan_type, price)
VALUES
  ('gratuito', 0),
  ('familiar', 7.99),
  ('universitario', 5.99),
...
INSERT INTO user (user_name, age, signature_date, subscription_id)
VALUES
...
VALUES
	...
	INSERT INTO history (user_id, song_id, date_listened)
    VALUES
