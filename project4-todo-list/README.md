...
<h2>Introdução</h2>
  ...
  Esse projeto foi o meu Número #4 dos meus projetos realizados no Curso de Desenvolvimento Web da Trybe. 
  Será desenvolvido uma lista de tarefas usando `HTML`, `CSS` e `JavaScript`.

  As competências avaliadas nesse projeto foram:
  1- Manipular CSS

  2- Manipular Javascript

<h2>Resultado</h2>
<img src ="project4-demo.gif" alt="projeto 4 demo">
